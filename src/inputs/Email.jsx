...
const Email = () => {
  ...
  return (
    <div className="relative w-full my-4">
      <input type="email" name='E-mail' class="input block rounded-lg px-2.5 py-3 w-full text-sm outline-none border-none focus:outline-none focus:ring-0 " placeholder={language === 'cir' ? 'Е-маил:' : 'E-mail:'} />
